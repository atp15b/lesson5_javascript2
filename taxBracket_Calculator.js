        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
              ...
              // Compute tax for married jointly filers or qualifying widow(er)s
               if (income <= 19050){
                 tax = income * 0.10;
                 taxRate = 10;
               }//end of nested if
...
function clearButton () {
              ...
              //This code removes the tax estimate results from the page.
              document.getElementById("taxEstimate").innerHTML = "";
              
              
              
              //This code removes the tax bracket results from the page. 
